...
set.seed(5)
b <- 25 # Upper bound
true_Y_bar <- .5/b; true_S_sq <- (0.2/b)^2; nsims <- 2.5e4
...
df_fill <- data.frame(mu = seq(0,1,0.005)*b, sigma_sq = 0) %>%
...
ggsave("Figures/Supplement_Figure2.pdf", width = 6, height = 2.1, dpi=600, units = "in")
